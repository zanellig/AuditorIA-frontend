          ...
          <section className='py-12 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-8'>
            <div className='container mx-auto text-center'>
              ...
              <p className='text-xl sm:text-2xl mb-8 max-w-4xl mx-auto text-muted-foreground'>
                ...
                llamadas, cumpliendo con las leyes argentinas y con total
              ...
              <div className='grid grid-cols-1 md:grid-cols-2 gap-8 w-full'>
                ...
                <Card>
                  <CardContent className='p-6'>
                    ...
                    <p>
                      Asegura que las ventas cumplan con las normativas legales
                      y mejora la experiencia del cliente al priorizar
          ...
          <section className='py-12 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-8'>
            <div className='container mx-auto text-center'>
              ...
              <p className='text-xl mb-8 max-w-3xl mx-auto'>
                ...
                centers y telemarketing, asegurando soluciones personalizadas
                que abordan sus desafíos específicos y mejoran la rentabilidad
                de su negocio.
              </p>
              <Button size='lg' asChild>
