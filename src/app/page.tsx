...
import { LoginButton, SignupButton } from "./_client-buttons/buttons"
...
export default function Home() {
  return (
    <div className='min-h-dvh bg-background text-foreground w-dvw'>
        ...
        <section className='py-12 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-8'>
          <div className='container mx-auto text-center'>
            <h1 className='text-4xl sm:text-5xl lg:text-6xl font-bold mb-6'>
              Auditoría de Llamadas <br /> con{" "}
              <span className='animate-sparkle'>Inteligencia Artificial</span>
            </h1>
            <p className='text-xl sm:text-2xl mb-8 max-w-4xl mx-auto text-muted-foreground text-wrap'>
              Optimice su servicio al cliente con análisis avanzado de llamadas,
              cumpliendo con las leyes argentinas y con total control de sus
              datos.
            </p>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8'>
              ...
              <Card>
                <CardContent className='p-6'>
                  ...
                  <p>
                    ...
                    postventa, identificando las mejores prácticas y resolviendo
              ...
              <Card>
                <CardContent className='p-6'>
                  ...
                  <p>
                    Asegura que las ventas cumplan con las normativas legales y
                    mejora la experiencia del cliente al priorizar reclamaciones
                    urgentes y detectar insatisfacción rápidamente.
                  </p>
                </CardContent>
              </Card>
            </div>
          ...
          <div className='container mx-auto'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
              <div className='flex flex-col items-center text-center'>
                ...
                <p>
                  Integración segura con su sistema de grabación existente para
                  capturar cada interacción en tiempo real.
                </p>
              </div>
              <div className='flex flex-col items-center text-center'>
                ...
                <p>
                  Transcripción precisa y segmentación de diálogos utilizando
        ...
        <section className='py-12 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-8'>
          <div className='container mx-auto text-center'>
            ...
            <p className='text-xl mb-8 max-w-3xl mx-auto'>
              LinkSolution, empresa certificada bajo la norma ISO 9001:2015 y
              reconocida como una de las mejores empresas para trabajar por
              Great Place to Work, ofrece soluciones de vanguardia en
              inteligencia artificial para optimizar procesos empresariales.
            </p>
            <p className='text-xl mb-8 max-w-3xl mx-auto'>
              Nuestro equipo de consultores altamente capacitados se mantiene
              actualizado en las últimas tendencias del sector de IT, contact
              centers y telemarketing, asegurando soluciones personalizadas que
              abordan sus desafíos específicos y mejoran la rentabilidad de su
              negocio.
            </p>
            <Button size='lg' asChild>
              <Link href='https://www.linksolution.com.ar/contacto' prefetch>
                Contáctenos
              </Link>
            </Button>
          </div>
